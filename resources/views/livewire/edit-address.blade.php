            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row row-cards">
                            <div class="col-md-12">
                                <!-- Select City -->
                                <div class="mb-3">
                                    <label for="citySelected" class="form-label">City</label>
                                            <input type="text" class="form-control" id="cityName" wire:model="cityName" disabled>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <a class="btn btn-outline-warning" href="{{ route('rota.viewregions') }}">{{ __('Back') }}</a>
                    </div>
                </div>
            </div>
        </div>
